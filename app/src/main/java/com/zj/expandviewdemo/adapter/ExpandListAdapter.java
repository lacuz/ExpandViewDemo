...
public class ExpandListAdapter extends ArrayAdapter<String> {
	...
	public ExpandListAdapter(Context context, List<String> listData, int sId, int nId) {
	...
	public ExpandListAdapter(Context context, String[] arrayData, int sId, int nId) {
